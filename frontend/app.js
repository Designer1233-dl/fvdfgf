...
function renderCurrentRaffle() {
  ...
  if (!raffle) {
    ...
    elements.heroCopy.textContent = "\u041A\u043E\u0433\u0434\u0430 \u043F\u043E\u044F\u0432\u0438\u0442\u0441\u044F \u043D\u043E\u0432\u0430\u044F \u0438\u0433\u0440\u0430, jackpot-\u043A\u043E\u043C\u043D\u0430\u0442\u0430 \u0438\u043B\u0438 \u0440\u043E\u0437\u044B\u0433\u0440\u044B\u0448, \u043E\u043D\u0438 \u0441\u0440\u0430\u0437\u0443 \u043F\u043E\u043A\u0430\u0436\u0443\u0442\u0441\u044F \u0437\u0434\u0435\u0441\u044C.";
...
function renderCurrentJackpot(jackpot) {
  ...
  elements.landingTitle.textContent = "\u041E\u0442 \u0418\u043B\u044E\u0448\u043A\u0438";
  elements.landingSubtitle.textContent = "\u0416\u0438\u0432\u0430\u044F jackpot-\u043A\u043E\u043C\u043D\u0430\u0442\u0430";
  elements.heroCopy.textContent = isClosing
  ...
  elements.raffleTitle.textContent = jackpot.title || "Jackpot Room";
  ...
  elements.quickStatus.textContent = isClosing
    ...
    : joined
      ...
      : "\u041C\u043E\u0436\u043D\u043E \u0437\u0430\u0439\u0442\u0438";
  if (elements.quickFormat) {
    elements.quickFormat.textContent = "\u0416\u0438\u0432\u0430\u044F jackpot-\u043A\u043E\u043C\u043D\u0430\u0442\u0430";
  }
  elements.joinButton.classList.remove("hidden");
...
function renderFinishedJackpot(jackpot) {
  ...
  elements.landingTitle.textContent = "\u041E\u0442 \u0418\u043B\u044E\u0448\u043A\u0438";
  elements.landingSubtitle.textContent = "\u0411\u0430\u043D\u043A \u0440\u0430\u0437\u044B\u0433\u0440\u0430\u043D";
  elements.heroCopy.textContent = hasWinner
    ? "\u041A\u043E\u043C\u043D\u0430\u0442\u0430 \u0437\u0430\u043A\u0440\u044B\u043B\u0430\u0441\u044C, \u0430 \u0432\u0435\u0441\u044C bank \u0443\u043B\u0435\u0442\u0435\u043B \u043E\u0434\u043D\u043E\u043C\u0443 \u0443\u0447\u0430\u0441\u0442\u043D\u0438\u043A\u0443."
  ...
  elements.playerBadge.textContent = hasWinner ? "\u0412\u044B\u0438\u0433\u0440\u044B\u0448" : "\u041F\u0443\u0441\u0442\u043E";
  ...
  elements.quickStatus.textContent = winner
    ...
    : hasWinner
      ...
      : "\u0418\u0433\u0440\u0430 \u043F\u0443\u0441\u0442\u0430";
  if (elements.quickFormat) {
    elements.quickFormat.textContent = "\u0424\u0438\u043D\u0430\u043B jackpot";
  }
  elements.joinButton.classList.add("hidden");
  elements.tasksButton?.classList.remove("hidden");
  elements.emptyProfileButton.classList.add("hidden");
  renderFinishedJackpotVisual(jackpot, winner);
}
...
function renderAdminDashboard() {
  ...
  elements.adminJackpotList.innerHTML = jackpotActive.length
    ...
    : '<div class="mini-card mini-card--muted">No live jackpot rooms yet.</div>';
  elements.adminJackpotHistoryList.innerHTML = jackpotHistory.length
    ? jackpotHistory.map(renderAdminJackpotHistoryCard).join("")
    : '<div class="mini-card mini-card--muted">No finished jackpot rooms yet.</div>';
}
...
function renderAdminJackpotCard(jackpot) {
  return `
    <div class="mini-card">
      <strong>${escapeHtml(jackpot.title || "Jackpot Room")}</strong>
      <span>${escapeHtml(getJackpotPrizeLine(jackpot))}</span>
      <span>${Number(jackpot.participantCount || 0)} players - ${formatStatus(jackpot.status)}</span>
      <div class="inline-actions">
        <button class="secondary small" type="button" data-action="copy-link" data-link="${escapeAttribute(jackpot.shareLink || "")}">Copy link</button>
        <button class="secondary small" type="button" data-action="finalize-jackpot" data-id="${escapeAttribute(jackpot.id)}">Finish now</button>
      </div>
    </div>
  `;
}
...
function renderAdminJackpotHistoryCard(jackpot) {
  const winner = jackpot?.winner?.usernameLabel || jackpot?.winner?.displayName || "No winner";
  return `
    <div class="mini-card">
      <strong>${escapeHtml(jackpot.title || "Jackpot Room")}</strong>
      <span>${escapeHtml(getJackpotPrizeLine(jackpot))}</span>
    ...
    .map((item, index) => {
      ...
      return `
        <div class="jackpot-orbit-card${joined ? " jackpot-orbit-card--viewer" : ""}" style="--orbit-index:${index}; --orbit-total:${Math.max(1, source.length)};">
          ${renderAvatarMarkup(item, "roulette-avatar")}
          <strong>${escapeHtml(item.usernameLabel || item.displayName || "Player")}</strong>
    ...
    html: `
      <div class="jackpot-stage">
        <div class="jackpot-core">
          <span class="jackpot-core__label">JACKPOT BANK</span>
          <strong>${escapeHtml(getJackpotPrizeLine(jackpot))}</strong>
          <span>${Number(jackpot.participantCount || 0)} players inside</span>
        </div>
...
function renderFinishedJackpotVisual(jackpot, viewerWinner) {
      ...
      <div class="jackpot-finish">
        ...
        <div class="jackpot-winner-card${viewerWinner ? " jackpot-winner-card--viewer" : ""}">
          ...
          <div class="jackpot-winner-copy">
            <span>${winner ? "\u041F\u043E\u0431\u0435\u0434\u0438\u0442\u0435\u043B\u044C jackpot" : "\u041A\u043E\u043C\u043D\u0430\u0442\u0430 \u043F\u0443\u0441\u0442\u0430"}</span>
            <strong>${escapeHtml(winner?.usernameLabel || winner?.displayName || jackpot.resultText || "No winner")}</strong>
...
async function onCreateJackpot(event) {
  ...
  try {
    ...
    state.currentRaffleSlug = "";
    if (payload.shareLink) {
      window.history.replaceState({}, "", `?jackpot=${encodeURIComponent(payload.jackpot?.slug || "")}`);
      copyText(payload.shareLink);
    }
    await refreshAll();
    showMessage(elements.adminMessage, "\u0416\u0438\u0432\u0430\u044F jackpot-\u043A\u043E\u043C\u043D\u0430\u0442\u0430 \u0441\u043E\u0437\u0434\u0430\u043D\u0430. \u0421\u0441\u044B\u043B\u043A\u0430 \u0443\u0436\u0435 \u0433\u043E\u0442\u043E\u0432\u0430.", "win");
  } catch (error) {
    showMessage(elements.adminMessage, formatError(error.message), "error");
  }
}
...
async function finalizeJackpotNow(jackpotId) {
  try {
    ...
    await refreshAll();
    showMessage(elements.adminMessage, "\u041A\u043E\u043C\u043D\u0430\u0442\u0430 jackpot \u0437\u0430\u043A\u0440\u044B\u0442\u0430.", "win");
  } catch (error) {
    showMessage(elements.adminMessage, formatError(error.message), "error");
  }
}
...
async function joinCurrentJackpot() {
  if (!state.currentJackpotSlug) {
    showMessage(elements.playerMessage, "\u041A\u043E\u043C\u043D\u0430\u0442\u0430 jackpot \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u0430.", "error");
    return;
  }
  if (!ensureTelegramProfile(elements.playerMessage)) {
    return;
  ...
  try {
    ...
    await refreshAll();
    showMessage(elements.playerMessage, "\u0424\u0440\u0438-\u0441\u0442\u0430\u0432\u043A\u0430 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430 \u0432 jackpot-\u0431\u0430\u043D\u043A.", "win");
  } catch (error) {
    showMessage(elements.playerMessage, formatPlayerError(error.message), "error");
  }
}
...
function pickFeaturedJackpot() {
  return state.activeJackpots[0] || state.recentFinishedJackpot || null;
}
...
function getJackpotPrizeLine(jackpot) {
  ...
  return `Bank ${formatMoney(total)} ${jackpot?.prizeAsset || ""} - free stake ${formatMoney(jackpot?.freeEntryAmount || 0)} ${jackpot?.prizeAsset || ""}`.trim();
}
...
function formatTransactionType(type) {
  ...
  map.jackpot_win = "Jackpot win";
  return map[type] || beautifyCode(type);
}

function formatError(code) {
  if (code === "jackpot_not_found") {
    return "Jackpot room was not found.";
  }
  if (code === "jackpot_not_active") {
    return "Jackpot room is not active.";
  }
  if (code === "jackpot_closed") {
    return "Jackpot room is already closed.";
  }
  if (code === "jackpot_free_entry_required") {
    return "Enter the free stake amount for the jackpot room.";
  }
  const map = {
  ...
  map.jackpot_not_found = "Jackpot room was not found.";
  map.jackpot_not_active = "Jackpot room is not active.";
  map.jackpot_closed = "Jackpot room is already closed.";
  map.jackpot_free_entry_required = "Enter the free stake amount for the jackpot room.";
